...
with PdfPages("learning_curve.pdf") as pdf:
    # Accuracy plot
...
print("Learning curve saved to learning_curve.pdf")
...
overall_precision = precision_score(y_test_encoded, y_pred, average="weighted")
overall_recall = recall_score(y_test_encoded, y_pred, average="weighted")
overall_f1 = f1_score(y_test_encoded, y_pred, average="weighted")
